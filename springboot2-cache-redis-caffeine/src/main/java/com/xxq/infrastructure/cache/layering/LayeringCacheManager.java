package com.xxq.infrastructure.cache.layering;

import com.github.benmanes.caffeine.cache.Caffeine;
import com.github.benmanes.caffeine.cache.CaffeineSpec;
import com.xxq.infrastructure.cache.setting.FirstCacheSetting;
import com.xxq.infrastructure.cache.setting.SecondaryCacheSetting;
...
//    private RedisCachePrefix cachePrefix = new DefaultRedisCachePrefix();
    ...
    protected Cache createCache(String name) {
        return new LayeringCache(name, null, redisOperations,
    ...
    public boolean getUsedFirstCache(String name) {
        ...
        return secondaryCacheSetting != null ? secondaryCacheSetting.isUsedFirstCache() : true;
    }
    /**
    ...
    public boolean getForceRefresh(String name) {
        ...
        return secondaryCacheSetting != null ? secondaryCacheSetting.isForceRefresh(): false;
    }
