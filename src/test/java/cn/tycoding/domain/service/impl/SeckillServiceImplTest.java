...
//    }
    ...
    public void testSeckillLogic() throws Exception {
        ExposerResp exposerResp = seckillService.exportSeckillUrl(1l);
        if (exposerResp.isExposed()) {
            long id = exposerResp.getSeckillId();
            BigDecimal money = BigDecimal.valueOf(200.00);
            long userPhone = 137337879;
            String md5 = exposerResp.getMd5();
            try {
                SeckillExecutionResp seckillExecutionResp = seckillService.executeSeckill(id, money, userPhone, md5);
                logger.info("result={}", exposerResp);
            ...
            //秒杀未开启
            logger.warn("exposer={}", exposerResp);
        }
    }
